...
export type TaskQueueEventEmitterFilter<TH, TR> = (task: TaskQueueItem<unknown, TH, TR>) => boolean;
export type TaskQueueEventEmitterCallback<TH, TR> = (task: TaskQueueItem<unknown, TH, TR>) => void;

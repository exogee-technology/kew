 ...
 */
var asyncStoragePlugin = function (key) { return ({
    storage: {
        load: function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, async_storage_1["default"].getItem(key)
                                .then(function (tasksJSON) { return tasksJSON ? JSON.parse(tasksJSON) : []; })["catch"](function () { return []; })];
        ...
        sync: function (queue) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, async_storage_1["default"].setItem(key, JSON.stringify(queue))];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
